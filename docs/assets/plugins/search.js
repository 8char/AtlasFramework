!(function () {
  var h = {},
    f = { EXPIRE_KEY: "docsify.search.expires", INDEX_KEY: "docsify.search.index" };
  function l(e) {
    var n = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
      ...
      n.forEach(function (e) {
        if ("heading" === e.type && e.depth <= o) {
          var n = (function (e) {
            ...
            t = n.str,
            a = n.config;
          (s = a.id ? i.toURL(r, { id: c(a.id) }) : i.toURL(r, { id: c(l(e.text)) })), (d[s] = { slug: s, title: t, body: "" });
        } else {
          if (!s) return;
          d[s] ? (d[s].body ? ((e.text = p(e)), (d[s].body += "\n" + (e.text || ""))) : ((e.text = p(e)), (d[s].body = d[s].body ? d[s].body + e.text : e.text))) : (d[s] = { slug: s, title: "", body: "" });
        }
      }),
      c.clear(),
      d
      ...
      if (
        ...
        (o.forEach(function (e) {
          var n,
            ...
            a = -1;
          if (((n = d ? d.search(t) : -1), (a = p ? p.search(t) : -1), 0 <= n || 0 <= a)) {
            (s += 0 <= n ? 3 : 0 <= a ? 2 : 0), a < 0 && (a = 0);
            var r,
              i = 0;
            (i = 0 == (r = a < 11 ? 0 : a - 10) ? 70 : a + e.length + 60), p && i > p.length && (i = p.length);
            var o =
              "..." +
              l(p)
                .substring(r, i)
  ...
  function i(t, a) {
            ...
            return (
              Docsify.dom.findAll(".sidebar-nav a:not(.section-link):not([data-nosearch])").forEach(function (e) {
                var n = e.href,
                  ...
                  a = r.parse(n).path;
                a && -1 === i.indexOf(a) && !Docsify.util.isAbsolutePath(t) && i.push(a);
              }),
              i
            );
          })(a.router)
    ...
    n.forEach(function (n) {
      if (h[n]) return l++;
      Docsify.get(a.router.getFile(n), !1, a.config.requestHeaders).then(function (e) {
        (h[n] = u(n, e, a.router, t.depth)),
          p === ++l &&
            (function (e, n, t) {
              localStorage.setItem(n, Date.now() + e), localStorage.setItem(t, JSON.stringify(h));
            })(t.maxAge, s, c);
      });
    });
  }
  ...
  function r(e) {
    ...
    if (!e) return t.classList.remove("show"), a.classList.remove("show"), (t.innerHTML = ""), void (d.hideOtherSidebarContent && (r.classList.remove("hide"), i.classList.remove("hide")));
    var o = c(e),
      s = "";
    o.forEach(function (e) {
      ...
      d.hideOtherSidebarContent && (r.classList.add("hide"), i.classList.add("hide"));
  }
  function a(e) {
    d = e;
  }
  ...
  var g = { placeholder: "Type to search", noData: "No Results!", paths: "auto", depth: 2, maxAge: 864e5, hideOtherSidebarContent: !1, namespace: void 0, pathNamespaces: void 0 };
  $docsify.plugins = [].concat(function (e, n) {
    ...
    Array.isArray(a)
      ...
      : "object" == typeof a &&
        ...
        (g.hideOtherSidebarContent = a.hideOtherSidebarContent || g.hideOtherSidebarContent),
